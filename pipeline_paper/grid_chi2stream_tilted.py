...
def h(x):
    a = 0.7989467394920438
    b = 0.7360945438109149
    return a+b*x

def worker(theta_0, xi_0, beta_0):
    """Parallel task."""
    print(theta_0, xi_0, beta_0)
    d_theta = xi_0 + h(theta_0)
...
if __name__ == "__main__":
    ...
    for beta in beta_lim:
        ...
        for i in range(0, len(args_iter)):
            args = args_iter[i]
            print('args =', args)
            theta_0, xi_0, beta_0 = args
            f.write("{}  {}  {}  {}".format(theta_0, xi_0, beta_0, chi[i]))
            f.write("\n")
