...
%
   ...
   \date{Accepted on 23/04/2024 by A$\&$A}
...
\begin{figure}
   \centering
   \includegraphics[width=\hsize]{observables_position.pdf}
   \includegraphics[width=\hsize]{observables_pmra.pdf}
   \includegraphics[width=\hsize]{observables_pmdec.pdf}
   \includegraphics[width=\hsize]{observables_helvel.pdf}
...
\begin{figure}
   \includegraphics[width=\hsize]{observables_heldist.pdf}
...
\begin{figure}
   \centering
   \includegraphics[width=\hsize]{chi2stream_contourf.pdf}
...
\begin{figure}
   \centering
   \includegraphics[width=\hsize]{chi2stream_tilted_contourf.pdf}
...
\begin{figure}
   \centering
   \includegraphics[width=\hsize]{rotation_curves.pdf}
...
%
\begin{figure}
   \includegraphics[width=1.0\hsize]{S2_Orbit_stream.pdf}
...
\begin{figure}
   \includegraphics[width=1.0\hsize]{S2_Z_Ra_Dec_2.pdf}
...
\begin{figure}
   \centering
   \includegraphics[width=\hsize]{density_profiles.pdf}
