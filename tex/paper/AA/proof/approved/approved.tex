...
\citet{Jiao2023} and \citet{Ou2023} from Gaia DR3 data. These authors reported data that are compatible with even lower values of the MW virial mass of $\approx 2\times10^{11} M_\odot$
(however, see \citealt{2024arXiv240519028K}),
%  $1.99^{+0.09}_{-0.06}\times10^{11} M_\odot$ and $2.13^{+0.17}_{-0.12}\times10^{11} M_\odot$, respectively,
...
% with a core mass $m_\mathrm{c}\approx M_{\rm{core}}$ and
% , however.
