...
$(\theta_0,\omega_0, \beta_0)\in [35, 40]\times[25, 30]\times[10^{-5}, 1.5\times10^{-5}]$. The algorithm converged to $(\theta_0, \omega_0, \beta_0)\approx (¿?)$ with a value of $\chi^2_{\rm{stream}}\approx ?$ and  $\chi^2_{\rm{core}}\approx ?\times10^{-6}$.
We polished this result by running again the genetic algorithm in a smaller window given by $(\theta_0,\omega_0, \beta_0)\in [35, 37]\times[26, 28]\times[1.2\times 10^{-5}, 1.3\times10^{-5}]$ converging
to $(\theta_0, \omega_0, \beta_0)\approx (36.06, 27.34, 1.258\times10^{-5})$ with a value of $\chi^2_{\rm{stream}}\approx 21.96$ and  $\chi^2_{\rm{core}}\approx 6.05\times10^{-6}$.
