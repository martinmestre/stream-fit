...
belongs to the interval $11.5 \lesssim D_g \lesssim 16.4$ (kpc), displayed as a vertical grey band.
Although the GD-1 stream location corresponds to $z\in [2.6, 9.7]$ kpc and thus explores the non-sphericality of the full MW models (due to baryons/NFW axisymmetry), the fact that both models approximately agree in their circular velocity values in the GD-1 region gives support to the attempt of using stellar streams as Galactic
accelerometers~\citep{Ibata_2016}.
It in interesting to note a coincidence between both models in their values of circular velocity
at the positon of the sun as they both give a value of $v_c(R_\odot)\approx 244$~km/s.
