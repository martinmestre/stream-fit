...
\end{eqnarray}
where $\Phi_B$ is the potential generated by the three barionic components and $M_{DM}(r)$ is the enclosed dark matter mass up to the a distance $r$. We have used the spherical symmetry property of the DM distribution in order to relate the acceleration with the enclosed mass.
