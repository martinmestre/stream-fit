...
$m_{\rm{vir}}=2.3\times10^{11} M_\odot$. This value is between the $1\sigma$ and $2\sigma$ errors in the estimation of the total mass of the MW at a radius of 50 kpc presented in Table 3 of Gibbons...2014, which is a total mass of $2.9\times10^{11} M_\odot$ with $(\sigma, 2\sigma)=(0.4,0.9)\times10^{11} M_\odot$.
