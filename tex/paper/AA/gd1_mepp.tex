...
with a core mass $m_c\approx m_core$ and more compact than our solution for $m=56$ keV, will
satisfy the S-stars contraint. It is interesting to test how much compactness can be reached
while keeping simultaneously the S-stars and GD-1 contraints in the light of the new observations
of the Event Horizon Telescope which demand\footnote{A precise ray tracing study on the image of the central
cores of fermionic distributions is on progress. This work will put strict constraints on the minimum
compactness needed to be in agreemnt with the EHT observations.} a compactness of the order of magnitude of 5 Schwarzschild
radii.
In order to extend our solutions to other values of the fermion mass ($m$)
