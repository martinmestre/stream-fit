...
between them modifies both subsystems. The host galaxy strips stars from the satellite at a rate that depends
on their density profiles and on the orbit (that decays due to dynamical friction),
thus constituting what is defined as a stellar (or tidal) stream. Simultaneously, the host density
profile suffers a reorganization of its matter in the vecinity of the satellite's orbit, developing a wake
due to the dynamical friction.

At present stellar streams constitute one of the main Milky Way (MW) observables, together with
other baryonic observables like the rotation curve, the radial surface density profile of the disk
and the vertical density profile of the disk at the solar radius.
Stellar streams probe the acceleration field produced by the Galaxy~\citep{1999ApJ...512L.109J,2016ASSL..420..169J,Ibata_2016,2017ApJ...842..120I,2017A&A...603A..65T} as well as its formation history according
