...
The corresponding orbit is displayed in the observable space in Figs.~\ref{fig:obs_pos}
and~\ref{fig:obs_vel} with a dashed (yellow) line.
...
\begin{figure*}
   ...
   \caption{Stream fits in observable space: sky position (top) and heliocentric distance (bottom).}
   \label{fig:obs_pos}
\end{figure*}
\begin{figure*}
   ...
   \caption{Stream fits in observable space: proper motion (top-middle) and heliocentric velocity (bottom).}
   \label{fig:obs_vel}
\end{figure*}
