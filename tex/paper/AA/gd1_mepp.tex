...
found is given by approximately by $\alpha_0=149.4^{\circ}$, $\delta_0=36.8^{\circ}$, $D_0=7.9$ kpc,
$\tilde{\mu}_{\alpha,0}=-7.1$ mas/yr, $\mu_{\delta,0}=-12.5$ mas/yr and $v_{h,0}=-17.3$ km/s.
