...
\subsection{Observables and backgound measurements}
The main observables used in this project are the polynomial fits performed by \citet{Ibata_2020} on GD-1 stream using astrometry (Gaia DR2), photometry and high-precision spectroscopy datasets together with
the analysis of the {\sc streamfinder} algorithm.
