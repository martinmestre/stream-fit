...
θ₀, Δθ₀, βᵣ₀ = 43.07980446840334, 29.5913682691353,  0.0029881093658168574*10.0^5
E = range(360.0, 380.0, step=0.01)
println("ϵ ∈ E = ", E)
# %%
outfile = "solutions_stream_core_GR_NLoptNelderMead_from360.txt"
for ϵ in E
    global θ₀, Δθ₀, βᵣ₀, x₀
    open(outfile, "a") do f
        # Core  χ²
