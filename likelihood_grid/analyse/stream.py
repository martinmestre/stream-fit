...
def chi2_stream(theta_0, d_theta, beta_0, ener_f, ic, r_sun):
    ...
    print(theta_0, d_theta, beta_0, '--- chi2 = ', np.sum(sum))
    return np.sum(sum), r, mass, nu


def log_likelihood(theta_0, d_theta, beta_0, ener_f, ic, r_sun):
    """Likelihood."""
    ll, r, mass, nu = chi2_stream(theta_0, d_theta, beta_0, ener_f, ic, r_sun)
    ll *= -1.0
    print('loglikelihood(', theta_0, d_theta, beta_0, ') = ', ll)
    return theta_0, d_theta, beta_0, ll, r, mass, nu
