"""
Fit GD-1 stream data with RAR model.

Computation of the orbit model for RAR + barionic component.
Using Ibata+20 polinomial data-fits. Optimization to find best fit orbit.
"""
...
param_fitted = opt.x
np.savetxt('param_fit_orbit-pot_from_IbataPolysGaiaDR2-data.txt', param_fitted, delimiter=',')
w_0 = param_fitted
print("w_0=", w_0)
ener_f = 56.0  # keV
theta_0, W_0, beta_0 = 3.77780827e+01, 6.63468885e+01, 1.20446329e-05
