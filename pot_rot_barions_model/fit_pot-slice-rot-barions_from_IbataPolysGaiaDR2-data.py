...
plt.legend()
plt.tight_layout()
fig.savefig("orbit_pot-slice-barions_from_IbataPolysGaiaDR2-data.png")
# plt.show()
...
# plt.tight_layout()
fig.savefig("sky_pot-slice-rot-barions_from_IbataPolysGaiaDR2-data.png")
# plt.show()
