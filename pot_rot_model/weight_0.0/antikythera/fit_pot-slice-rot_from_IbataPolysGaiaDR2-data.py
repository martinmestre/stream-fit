...
# param_file = 'param_halomass1.6e11.txt'
...
print('core mass = ', mass_core/1.e11, 'x10^11 Mass_sun')
print('virial radius = ', rar_halo.r_s[-1])
print('halo virial mass =', rar_halo.mass_wrap(rar_halo.r_s[-1])/1.e11, 'x10^11 M_sun')
# ---------
# Plots
# ----------
...
plt.legend()
plt.tight_layout()
fig.savefig("orbit_pot-slice-rot_from_IbataPolysGaiaDR2-data_corr.png")
# plt.show()
...
# plt.tight_layout()
fig.savefig("sky_pot-slice-rot-rot_from_IbataPolysGaiaDR2-data_corr.png")
# plt.show()
...
plt.savefig('rotation_curve_beta0_1.25e-5_corr.png')
# plt.show()
